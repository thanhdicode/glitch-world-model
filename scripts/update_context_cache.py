...
## Current Blocker
- Topic A remains method-paper-incomplete because K1-K4 empirical evidence is still missing:
  learned-baseline execution on the exact follow-up support, public-benchmark scoring, controlled
  SIGReg/action ablation, and temporal-localization metric surface.
- Any K1 launch must use the refreshed P1 frozen follow-up support and the new learned-baseline
  runner/validator rather than the older bounded artifacts.
...
- Next phase: stop at the user-operated Kaggle gate K1, run the Phase P2 learned baselines on the
  frozen follow-up support, and validate the downloaded artifacts locally.
- Later phases: P3 GlitchBench, P4 SIGReg/action ablation, P5 temporal localization or explicit
  future-work scoping, P6 demo, P7 full paper rewrite.
