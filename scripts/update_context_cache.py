...
## Current Blocker
- Topic A remains method-paper-incomplete because the repo still needs the P6 demo lane and the P7
  full paper rewrite on top of the current bounded evidence.
...
- Next phase on this branch: Phase P6 demo + reproducibility.
- Later phases: P7 full paper rewrite.
