...
## Current Blocker
- Topic A is now method-paper-complete locally, but the official LLNCS build, PDF metadata check,
  and external similarity screening still require the Springer/Overleaf toolchain outside this
  workspace.
...
- Next phase on this branch: official LLNCS build, anonymization/PDF metadata check, and
  submission handoff after the completed local P7 rewrite.
