...
def build_project_state(meta: CacheMetadata, root: Path) -> str:
    blocker = (
        "v5 source/package/fingerprint plus validated Kaggle CUDA/resume artifact set"
        if has_gate5_conflict_record(root)
        else "missing validated Kaggle CUDA/resume artifact set"
    )
...
- Current v5 package status: `BLOCKED_ON_DATASET`.
- V5 kernel fingerprint: `PENDING`.
