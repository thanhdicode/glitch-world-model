...
- Current phase: the first bounded paper draft is complete from validated non-locked evidence.
- Next phase: paper claim/build audit and bounded-submission versus new-compute decision.
