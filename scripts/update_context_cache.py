...
## Current Blocker
- The non-locked evaluation has only one buggy episode and correlated windows.
- Normal-P95 threshold calibration produced zero recall/F1 for every LeWM aggregation despite
  finite AUROC/AUPRC.
...
## What Changed
- Recorded real LeWM scores, same-manifest baselines, and validation-only pilot metrics.

## Checks Passed
- Pending final verification for this task.

## Safety Status
- Gates 1-9 completed through a limited non-locked window-level pilot.
...
## Open Blockers
- Broader non-locked buggy validation coverage and threshold calibration remain unresolved.

## Next Recommended Task
- Broaden non-locked validation before any Gate 10 decision.
