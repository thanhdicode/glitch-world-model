...
% TODO-KA: insert Kaggle K-A numbers here when available (R5-XGame locked-test AUROC, AUPRC)
...
% TODO-KB: upgrade to "significantly outperforms (DeLong p<0.05)" if Kaggle K-B confirms
...
% TODO-KA: report locked-test R5-XGame AUROC here once Kaggle K-A is materialized
