...
Benchmark mismatch & K2 is image-level and synthetic-normal & Treat K2 as a bounded negative comparison surface only \\
Mechanistic negative readout & K3 does not show a positive SIGReg/action trend & Keep K3 in loss-diagnostic language rather than detector language \\
