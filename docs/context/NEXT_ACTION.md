...
builder. The next external action is to verify the direct `/kaggle/input` dry-run on Kaggle, then
launch the full K2 run with the LeWM seed artifact dataset attached.
