...
LOG_PATH="${LOG_PATH:-/kaggle/working/r5_xgame_resume_missing_seed44.log}"
...
echo "=== R5-XGame resume/finalize Kaggle run ==="
...
python scripts/run_r5_xgame_resume_missing_seed44.py \
  --manifest "$MANIFEST" \
...
echo "=== R5-XGame resume/finalize run complete ==="
